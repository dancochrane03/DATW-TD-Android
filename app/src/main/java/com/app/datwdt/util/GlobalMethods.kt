...
//          write the compressed bitmap at the destination specified by filename.
    ...
    companion object {
        ...
        fun setDialog(context: Context, msg: String?, dialogListener: DialogListener2?) {
            ...
            dialog!!.setContentView(R.layout.dialog_message_yes_no)
            dialog!!.window!!.setBackgroundDrawableResource(android.R.color.transparent)
            val txt_dialog_msg = dialog!!.findViewById<TextView>(R.id.txt_dialog_msg)
            val txt_dialog_yes = dialog!!.findViewById<TextView>(R.id.txt_dialog_yes)
            val txt_dialog_no = dialog!!.findViewById<TextView>(R.id.txt_dialog_no)
            txt_dialog_msg.text = msg
            txt_dialog_yes.setOnClickListener {
                dialog!!.dismiss()
                dialogListener?.setOnYesClick()
            }
            txt_dialog_no.setOnClickListener {
                dialog!!.dismiss()
                dialogListener?.setOnNoClick()
            }
            ...
            if (!(context as AppCompatActivity).isFinishing) dialog!!.show()
        }
        ...
        fun Dialog(context: Context, msg: String?, ok: String?) {
            if ( dialog != null &&  dialog!!.isShowing) {
                 dialog!!.dismiss()
            }
            if ( dialog != null) {
             ...
             dialog!!.window!!.setBackgroundDrawableResource(android.R.color.transparent)
            val txt_dialog_msg =  dialog!!.findViewById<TextView>(R.id.txt_dialog_msg)
            val txt_dialog_ok =  dialog!!.findViewById<TextView>(R.id.txt_dialog_ok)
//            txt_dialog_ok.setTextColor(context.resources.getColor(R.color.white))
            txt_dialog_msg.text = msg
            txt_dialog_ok.text = ok
            txt_dialog_ok.setOnClickListener {  dialog!!.dismiss() }
            val window =  dialog!!.window
            val wlp = window!!.attributes
